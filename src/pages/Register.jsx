...
export default function Register() {
  ...
  const inputClass =
    'w-full border border-rule rounded-xl px-3.5 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/40 focus:border-primary-500 transition-colors'
    ...
    <div className="min-h-screen flex items-center justify-center bg-paper px-4 py-10">
      <div className="w-full max-w-sm">
        <div className="flex justify-center mb-5">
          <StampBadge status="draft" size="md" />
        </div>
