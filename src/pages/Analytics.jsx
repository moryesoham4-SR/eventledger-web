...
function AnalyticsContent({ eventId }) {
  ...
  const tooltipStyle = { background: ct.tooltipBg, border: `1px solid ${ct.tooltipBorder}`, borderRadius: 8, fontSize: 12, color: ct.tooltipText }
        ...
        <ChartCard title="Revenue vs Expense" hint="Estimated vs. actual, side by side">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={revenueVsExpense}>
              ...
              <Tooltip formatter={fmt} contentStyle={tooltipStyle} cursor={{ fill: ct.grid, opacity: 0.3 }} />
