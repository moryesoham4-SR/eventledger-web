    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        <p className="text-sm text-gray-500">
          Total: <span className="font-semibold text-emerald-600">{formatMoney(total)}</span>
        </p>
        <button
      ...
      {loading ? (
        ...
        <p className="text-gray-500 text-sm">No {mode} income yet.</p>
      ) : (
            ...
            <div key={item.id} className="flex items-center justify-between px-5 py-3">
              <div>
                <p className="font-medium text-gray-900 text-sm">
                  {item.source} <span className="text-xs font-normal text-gray-400">· {item.category}</span>
                </p>
