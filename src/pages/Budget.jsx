      ...
      {showLineForm && canEdit && (
        <form onSubmit={handleAddLine} className="bg-well border border-rule rounded-xl p-4 mb-4 space-y-2">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            <input placeholder="Category" required value={line.category} onChange={(e) => setLine({ ...line, category: e.target.value })} className="border border-rule rounded-lg px-2.5 py-1.5 text-sm bg-well" />
            <input placeholder="Item name" value={line.item_name} onChange={(e) => setLine({ ...line, item_name: e.target.value })} className="border border-rule rounded-lg px-2.5 py-1.5 text-sm bg-well" />
            <input placeholder="Unit (e.g. pcs)" value={line.unit} onChange={(e) => setLine({ ...line, unit: e.target.value })} className="border border-rule rounded-lg px-2.5 py-1.5 text-sm bg-well" />
            <input type="number" step="0.01" placeholder="Quantity" value={line.quantity} onChange={(e) => setLine({ ...line, quantity: e.target.value })} className="border border-rule rounded-lg px-2.5 py-1.5 text-sm bg-well" />
            <input type="number" step="0.01" placeholder="Unit price" required value={line.unit_price} onChange={(e) => setLine({ ...line, unit_price: e.target.value })} className="border border-rule rounded-lg px-2.5 py-1.5 text-sm bg-well" />
            <input placeholder="Description" value={line.description} onChange={(e) => setLine({ ...line, description: e.target.value })} className="border border-rule rounded-lg px-2.5 py-1.5 text-sm bg-well" />
          </div>
        ...
        <form onSubmit={handleCreate} className="bg-card border border-rule rounded-xl p-5 mb-6 space-y-3">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <select
              ...
              className="border border-rule rounded-lg px-3 py-2 text-sm disabled:bg-well disabled:text-ink/50"
            >
