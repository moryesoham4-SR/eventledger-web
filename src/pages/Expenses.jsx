        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <div className="relative">
            <input
              ...
              className="bg-well border border-rule rounded-full px-3.5 py-1.5 pl-8 text-xs text-ink placeholder:text-ink/40 focus:outline-none focus:border-primary-500 w-52 sm:w-64 transition-all"
            />
