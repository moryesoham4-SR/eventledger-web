...
export default function Layout() {
    ...
    <>
      ...
      <div className="px-5 py-3 border-b border-rule">
        ...
        <select
          ...
          className="w-full border border-rule rounded px-2 py-1.5 text-sm bg-white text-ink"
        >
          ...
          return (
            <Link
              ...
              className={`relative flex items-center gap-2.5 px-5 py-2.5 text-sm ${
                active ? 'text-primary-600 font-semibold' : 'text-ink/65 font-medium hover:text-ink'
              }`}
            >
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-paper">
      ...
      <div className="md:hidden flex items-center justify-between bg-white border-b border-rule px-4 py-3">
        <button
      ...
      <aside
        className={`
          bg-white border-r border-rule flex flex-col
